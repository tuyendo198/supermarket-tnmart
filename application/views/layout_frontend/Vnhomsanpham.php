<div class="title_chitiet_bot" style="border-bottom: 1px solid #ebebeb; margin-bottom: 20px;">
	<div class="lblChitiet">
		<ul>
			...
			<li>
				<a href="">Danh mục sản phẩm</a> <i class="fa fa-angle-right" aria-hidden="true"></i>
			</li>
			<li>
				<a href="">{$thongTinNhomSP.sTenNhomSP}</a>
			</li>
		</ul>
	</div>
</div>
		...
		<div class="col-md-9">
			<div class="col-md-12">
				<div class="col-md-8" style="padding-left: 0px;">
					<h3 style="margin-top: 10px; font-weight: 700; color: #d60404;">{$thongTinNhomSP.sTenNhomSP}</h3>
				</div>
			...
			<div class="sanpham col-md-12 danhsachsanpham">
				...
				<div class="sp col-md-4" data-maphanloai="" data-gia="{$v.fGiaSP}">
